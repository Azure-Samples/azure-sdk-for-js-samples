import {
  ...
  async function dedicatedHostGroups_createOrUpdate() {
    ...
    await client.dedicatedHostGroups
      .createOrUpdate(resourceGroupName, host_group_name, parameter)
      .then((response) => {
  ...
  async function dedicatedHostGroups_get() {
    await client.dedicatedHostGroups
      .get(resourceGroupName, host_group_name)
      .then((response) => {
        console.log(response);
      });
  }
  ...
  async function dedicatedHostGroups_update() {
    ...
    await client.dedicatedHostGroups
      .update(resourceGroupName, host_group_name, parameter)
      .then((result) => {
        console.log(result);
      });
  }
  ...
  async function dedicatedHosts_get() {
    await client.dedicatedHosts
      .get(resourceGroupName, host_group_name, host_name)
      .then((response) => {
        console.log(response);
      });
  }
  ...
  async function dedicatedHostGroups_delete() {
    await client.dedicatedHostGroups
      .delete(resourceGroupName, host_group_name)
      .then((response) => {
        console.log(response);
      });
  }
