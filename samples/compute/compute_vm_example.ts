import { ComputeManagementClient,VirtualMachine,RunCommandInput,VirtualMachineUpdate,VirtualMachineExtension,VirtualMachineExtensionUpdate } from "@azure/arm-compute";
...
async function virtualMachines_createOrUpdate(){
    ...
    await client.virtualMachines.beginCreateOrUpdateAndWait(resourceGroupName,virtual_machine_name,parameter).then(
        response => {
...
async function virtualMachines_instanceView(){
    await client.virtualMachines.instanceView(resourceGroupName,virtual_machine_name).then(
        response => {
            console.log(response)
        }
    )
...
async function virtualMachines_listAvailableSizes(){
    for await (let item of client.virtualMachines.listAvailableSizes(resourceGroupName,virtual_machine_name)){
        console.log(item);
    }
}
...
async function virtualMachines_get(){
    await client.virtualMachines.get(resourceGroupName,virtual_machine_name).then(
        response => {
            console.log(response)
        }
    )
...
async function virtualMachines_runCommand(){
    ...
    await client.virtualMachines.beginRunCommandAndWait(resourceGroupName,virtual_machine_name,parameter).then(
        response => {
            console.log(response)
        }
    )
...
async function virtualMachines_restart(){
    await client.virtualMachines.beginRestartAndWait(resourceGroupName,virtual_machine_name).then(
        response => {
            console.log(response)
        }
    )
...
async function virtualMachines_powerOff(){
    await client.virtualMachines.beginPowerOffAndWait(resourceGroupName,virtual_machine_name).then(
        response => {
            console.log(response)
        }
    )
...
async function virtualMachines_start(){
    await client.virtualMachines.beginStartAndWait(resourceGroupName,virtual_machine_name).then(
        response => {
            console.log(response)
        }
    )
...
async function virtualMachines_reapply(){
    ...
    await client.virtualMachines.beginReapplyAndWait(resourceGroupName,virtual_machine_name).then(
        response => {
            console.log(response)
        }
    )
...
async function virtualMachines_redeploy(){
    await client.virtualMachines.beginRedeployAndWait(resourceGroupName,virtual_machine_name).then(
        response => {
            console.log(response)
        }
    )
...
async function virtualMachines_update(){
    ...
    await client.virtualMachines.beginUpdateAndWait(resourceGroupName,virtual_machine_name,parameter).then(
        response => {
            console.log(response)
        }
    )
...
async function virtualMachines_generalize(){
    await client.virtualMachines.generalize(resourceGroupName,virtual_machine_name).then(
        response => {
            console.log(response)
        }
    )
...
async function virtualMachines_deallocate(){
    await client.virtualMachines.beginDeallocateAndWait(resourceGroupName,virtual_machine_name).then(
        response => {
            console.log(response)
        }
    )
...
async function virtualMachines_delete(){
    await client.virtualMachines.beginDeleteAndWait(resourceGroupName,virtual_machine_name).then(
        response => {
            console.log(response)
        }
    )
...
async function MachineExtensions_createOrUpdate(){
    ...
    await client.virtualMachineExtensions.beginCreateOrUpdateAndWait(resourceGroupName,virtual_machine_name,virtual_machine_extension_name,parameter).then(
        response => {
            console.log(response)
        }
    )
...
async function MachineExtensions_get(){
    await client.virtualMachineExtensions.get(resourceGroupName,virtual_machine_name,virtual_machine_extension_name).then(
        response => {
            console.log(response)
        }
    )
...
async function MachineExtensions_list(){
    await client.virtualMachineExtensions.list(resourceGroupName,virtual_machine_name).then(
        response => {
            console.log(response)
        }
    )
...
async function MachineExtensions_update(){
    ...
    await client.virtualMachineExtensions.beginUpdateAndWait(resourceGroupName,virtual_machine_name,virtual_machine_extension_name,parameter).then(
        response => {
            console.log(response)
        }
    )
...
async function MachineExtensions_delete(){
    await client.virtualMachineExtensions.beginDeleteAndWait(resourceGroupName,virtual_machine_name,virtual_machine_extension_name).then(
        response => {
            console.log(response)
        }
    )
...
async function MachineRunCommands_get(){
    ...
    await client.virtualMachineRunCommands.get(location,commandId).then(
        res => {
            console.log(res)
        }
    )
...
async function virtualMachineImages_get(){
    await client.virtualMachineImages.get(location,publisher_name,offer,skus,version).then(
        response => {
            console.log(response)
        }
    )
...
async function virtualMachineImages_list(){
    await client.virtualMachineImages.list(location,publisher_name,offer,skus).then(
        response => {
            console.log(response)
        }
    )
...
async function virtualMachineImages_listOffers(){
    await client.virtualMachineImages.listOffers(location,publisher_name).then(
        response => {
            console.log(response)
        }
    )
...
async function virtualMachineImages_listPublishers(){
    await client.virtualMachineImages.listPublishers(location).then(
        response => {
            console.log(response)
        }
    )
...
async function virtualMachineImages_listSkus(){
    await client.virtualMachineImages.listSkus(location,publisher_name,offer).then(
        response => {
            console.log(response)
        }
    )
...
async function virtualMachineExtensionImages_get(){
    await client.virtualMachineExtensionImages.get(location,extension_publisher_name,extension_image_version,extension_image_type).then(
        response => {
            console.log(response)
        }
    )
...
async function virtualMachineExtensionImages_listTypes(){
    await client.virtualMachineExtensionImages.listTypes(location,extension_publisher_name).then(
        response => {
            console.log(response)
        }
    )
...
async function virtualMachineExtensionImages_listVersions(){
    await client.virtualMachineExtensionImages.listVersions(location,extension_publisher_name,extension_image_type).then(
        response => {
            console.log(response)
        }
    )
