import { SqlManagementClient,ServerSecurityAlertPolicy,ServerBlobAuditingPolicy,ExtendedServerBlobAuditingPolicy,ServerAzureADAdministrator,
VirtualNetworkRule, } from "azure-arm-sql";
...
async function servers_beginCreateOrUpdateAndWait(){
    const res = await client.servers.beginCreateOrUpdateAndWait(resourceGroup,serverName,{location:"eastus",administratorLogin:"dummylogin",administratorLoginPassword:"Un53cuRE!"});
    console.log(res);
}
...
async function serverSecurityAlertPolicies_beginCreateOrUpdateAndWait(){
    ...
    const res = await client.serverSecurityAlertPolicies.beginCreateOrUpdateAndWait(resourceGroup,serverName,securityAlterPolicyName,parameter);
    console.log(res);
}

//serverSecurityAlertPolicies.get
async function serverSecurityAlertPolicies_get(){
    const res = await client.serverSecurityAlertPolicies.get(resourceGroup,serverName,securityAlterPolicyName);
    console.log(res);
}

//serverSecurityAlertPolicies.listByServer
async function serverSecurityAlertPolicies_listByServer(){
    for await (let item of client.serverSecurityAlertPolicies.listByServer(resourceGroup,serverName)){
        console.log(item);
    }
}
...
async function serverBlobAuditingPolicies_beginCreateOrUpdateAndWait(){
    ...
    await client.serverBlobAuditingPolicies.beginCreateOrUpdateAndWait(resourceGroup,serverName,parameter).then(
        res => {
            console.log(res);
        }
    )
...
async function extendedServerBlobAuditingPolicies_beginCreateOrUpdateAndWait(){
    ...
    const res = await client.extendedServerBlobAuditingPolicies.beginCreateOrUpdateAndWait(resourceGroup,serverName,parameter);
    console.log(res);
}

//extendedServerBlobAuditingPolicies.get
async function extendedServerBlobAuditingPolicies_get(){
    await client.extendedServerBlobAuditingPolicies.get(resourceGroup,serverName).then(
        res => {
            console.log(res);
        }
    )
...
async function serverBlobAuditingPolicies_get(){
    await client.serverBlobAuditingPolicies.get(resourceGroup,serverName).then(
        res => {
            console.log(res);
        }
    )
...
async function serverBlobAuditingPolicies_listByServer(){
    for await (let item of client.serverBlobAuditingPolicies.listByServer(resourceGroup,serverName)){
        console.log(item);
    }
}
...
async function extendedServerBlobAuditingPolicies_listByServer(){
    for await (let item of client.extendedServerBlobAuditingPolicies.listByServer(resourceGroup,serverName)){
        console.log(item);
    }
}
...
async function serverAzureADAdministrators_beginCreateOrUpdateAndWait(){
    ...
    const res = await client.serverAzureADAdministrators.beginCreateOrUpdateAndWait(resourceGroup,serverName,administratorName,parameter);
    console.log(res);
}

//serverAzureADAdministrators.listByServer
async function serverAzureADAdministrators_listByServer(){
    for await (let item of client.serverAzureADAdministrators.listByServer(resourceGroup,serverName)){
        console.log(item);
        return item.name;
    }
}
...
async function serverAzureADAdministrators_get(){
    ...
    await client.serverAzureADAdministrators.get(resourceGroup,serverName,adminName).then(
        res => {
            console.log(res);
        }
    )
...
async function serverAzureADAdministrators_beginDeleteAndWait(){
    const adminName = await serverAzureADAdministrators_listByServer();
    await client.serverAzureADAdministrators.beginDeleteAndWait(resourceGroup,serverName,adminName).then(
        res => {
            console.log(res);
        }
    )
...
async function serverAutomaticTuningOperations_get(){
    const res = await client.serverAutomaticTuningOperations.get(resourceGroup,serverName);
    console.log(res);
}

//serverAutomaticTuningOperations.update
async function serverAutomaticTuningOperations_update(){
    const res = await client.serverAutomaticTuningOperations.update(resourceGroup,serverName,{desiredState: "Auto"});
    console.log(res);
}
...
async function serviceObjectives_listByServer(){
    for await (let item of client.serviceObjectives.listByServer(resourceGroup,serverName)){
        console.log(item);
        return item.name;
    }
}
...
async function serviceObjectives_get(){
    ...
    const res = await client.serviceObjectives.get(resourceGroup,serverName,serviceObjectiveName);
    console.log(res);
}
...
async function createVirtualNetworkAndSubnet(){
    ...
    const vir_res = await network_client.virtualNetworks.beginCreateOrUpdateAndWait(resourceGroup,virtualNetworkName,{location:"eastus",addressSpace: {addressPrefixes: ['10.0.0.0/16']}});
    console.log(vir_res);

    //create subnet
    const sub_res = await network_client.subnets.beginCreateOrUpdateAndWait(resourceGroup,virtualNetworkName,subnetName,{addressPrefix: '10.0.0.0/24'});
    console.log(sub_res);
}
...
async function virtualNetworkRules_beginCreateOrUpdateAndWait(){
    const parameter:VirtualNetworkRule = {
        ...
        virtualNetworkSubnetId: "/subscriptions/" + subscriptionId + "/resourceGroups/" + resourceGroup + "/providers/Microsoft.Network/virtualNetworks/" + virtualNetworkName + "/subnets/" + subnetName
    };
    const res = await client.virtualNetworkRules.beginCreateOrUpdateAndWait(resourceGroup,serverName,virtualNetworkRuleName,parameter);
    console.log(res);
}

//virtualNetworkRules.get
async function virtualNetworkRules_get(){
    const res = await client.virtualNetworkRules.get(resourceGroup,serverName,virtualNetworkRuleName);
    console.log(res);
}

//virtualNetworkRules.listByServer
async function virtualNetworkRules_listByServer(){
    for await (let item of client.virtualNetworkRules.listByServer(resourceGroup,serverName)){
        console.log(item);
    }
}
...
async function virtualNetworkRules_beginDeleteAndWait(){
    await client.virtualNetworkRules.beginDeleteAndWait(resourceGroup,serverName,virtualNetworkRuleName).then(
        res => {
            console.log(res);
        }
    )
...
async function serverCommunicationLinks_beginCreateOrUpdateAndWait(){
    const res = await client.serverCommunicationLinks.beginCreateOrUpdateAndWait(resourceGroup,serverName,communicationName,{partnerServer:partnerServerName});
    console.log(res);
}

//serverCommunicationLinks.get
async function serverCommunicationLinks_get(){
    const res = await client.serverCommunicationLinks.get(resourceGroup,serverName,communicationName);
    console.log(res);
}

//serverCommunicationLinks.listByServer
async function serverCommunicationLinks_listByServer(){
    for await (let item of client.serverCommunicationLinks.listByServer(resourceGroup,serverName)){
        console.log(item);
    }
}
...
async function serverCommunicationLinks_delete(){
    const res = await client.serverCommunicationLinks.delete(resourceGroup,serverName,communicationName);
    console.log(res);
}
...
async function serverUsages_listByServer(){
    for await (let item of client.serverUsages.listByServer(resourceGroup,serverName)){
        console.log(item);
    }
}
...
async function servers_beginUpdateAndWait(){
    const res = await client.servers.beginUpdateAndWait(resourceGroup,serverName,{administratorLogin:"dummylogin",administratorLoginPassword:"Un53cuRE!"});
    console.log(res);
}

//servers.checkNameAvailability
async function servers_checkNameAvailability(){
    const res = await client.servers.checkNameAvailability({name: "server1",type: "Microsoft.Sql/servers"});
    console.log(res);
}
