import { SqlManagementClient,Server,Database,BackupShortTermRetentionPolicy,CreateDatabaseRestorePointDefinition,DatabaseBlobAuditingPolicy,
    WorkloadGroup,LongTermRetentionPolicy,ResourceMoveDefinition,DatabaseUpdate } from "azure-arm-sql";
...
async function servers_beginCreateOrUpdateAndWait(){
    ...
    await client.servers.beginCreateOrUpdateAndWait(resourceGroup,serverName,parameter).then(
        res => {
            console.log(res);
        }
    )
...
async function databases_beginCreateOrUpdateAndWaitAboutBackupShortTermRetentionPolicies(){
    ...
    await client.databases.beginCreateOrUpdateAndWait(resourceGroup,serverName,databaseName,parameter).then(
        res => {
            console.log(res);
        }
    )
...
async function backupShortTermRetentionPolicies_beginCreateOrUpdateAndWait(){
    ...
    await client.backupShortTermRetentionPolicies.beginCreateOrUpdateAndWait(resourceGroup,serverName,databaseName,policyName,parameter).then(
        res => {
            console.log(res);
        }
    )
...
async function backupShortTermRetentionPolicies_get(){
    await client.backupShortTermRetentionPolicies.get(resourceGroup,serverName,databaseName,policyName).then(
        res => {
            console.log(res);
        }
    )
...
async function backupShortTermRetentionPolicies_listByDatabase(){
    for await (let item of client.backupShortTermRetentionPolicies.listByDatabase(resourceGroup,serverName,databaseName)){
        console.log(item);
    }
}
...
async function backupShortTermRetentionPolicies_beginUpdateAndWait(){
    ...
    await client.backupShortTermRetentionPolicies.beginUpdateAndWait(resourceGroup,serverName,databaseName,policyName,parameter).then(
        res => {
            console.log(res);
        }
    )
...
async function databases_beginDeleteAndWaitAboutBackupShortTermRetentionPolicies(){
    const res = await client.databases.beginDeleteAndWait(resourceGroup,serverName,databaseName);
    console.log(res);
}
...
async function restorePoints_beginCreateAndWait(){
    ...
    await client.restorePoints.beginCreateAndWait(resourceGroup,serverName,databaseName,parameter).then(
        res => {
            console.log(res);
        }
    )
...
async function restorePoints_listByDatabase(){
    for await (let item of client.restorePoints.listByDatabase(resourceGroup,serverName,databaseName)){
        console.log(item);
        return item.name;
    }
}
...
async function restorePoints_get(){
    ...
    await client.restorePoints.get(resourceGroup,serverName,databaseName,restorePointName).then(
        res => {
            console.log(res);
        }
    )
...
async function restorePoints_delete(){
    const restorePointName = await restorePoints_listByDatabase();
    await client.restorePoints.delete(resourceGroup,serverName,databaseName,restorePointName).then(
        res => {
            console.log(res);
        }
    )
...
async function databaseAutomaticTuningOperations_get(){
    await client.databaseAutomaticTuningOperations.get(resourceGroup,serverName,databaseName).then(
        res => {
            console.log(res);
        }
    )
...
async function databaseAutomaticTuningOperations_update(){
    await client.databaseAutomaticTuningOperations.update(resourceGroup,serverName,databaseName,{desiredState: "Auto"}).then(
        res => {
            console.log(res);
        }
    )
...
async function databaseAdvisors_listByDatabase(){
    await client.databaseAdvisors.listByDatabase(resourceGroup,serverName,databaseName).then(
        res => {
            console.log(res);
            return res[0].name;
        }
...
async function databaseAdvisors_get(){
    ...
    await client.databaseAdvisors.get(resourceGroup,serverName,databaseName,"CreateIndex").then(
        res => {
            console.log(res);
        }
    )
...
async function createStorageAccountAndBlobContainer(){
    ...
    await storage_client.storageAccounts.beginCreateAndWait(resourceGroup,storageAccountName,parameter).then(
        res => {
            console.log(res);
        }
    )
    // create blobContainer
    await storage_client.blobContainers.create(resourceGroup,storageAccountName,blobContainerName,{}).then(
        res => {
            console.log(res);
        }
    )
    ...
    //regenerateKey
    const res = await storage_client.storageAccounts.regenerateKey(resourceGroup,storageAccountName,{keyName: "key2"});
    console.log(res);
...
async function databaseBlobAuditingPolicies_createOrUpdate(){
    ...
    await client.databaseBlobAuditingPolicies.createOrUpdate(resourceGroup,serverName,databaseName,parameter).then(
        res => {
            console.log(res);
        }
    )
...
async function databaseBlobAuditingPolicies_get(){
    await client.databaseBlobAuditingPolicies.get(resourceGroup,serverName,databaseName).then(
        res => {
            console.log(res);
        }
    )
...
async function workloadGroups_beginCreateOrUpdateAndWait(){
    ...
    await client.workloadGroups.beginCreateOrUpdateAndWait(resourceGroup,serverName,databaseName,workloadGroupName,parameter).then(
        res => {
            console.log(res);
        }
    )
...
async function workloadGroups_get(){
    await client.workloadGroups.get(resourceGroup,serverName,databaseName,workloadGroupName).then(
        res => {
            console.log(res);
        }
    )
...
async function workloadGroups_listByDatabase(){
    for await (let item of client.workloadGroups.listByDatabase(resourceGroup,serverName,databaseName)){
        console.log(item);
    }
}
...
async function workloadGroups_beginDeleteAndWait(){
    await client.workloadGroups.beginDeleteAndWait(resourceGroup,serverName,databaseName,workloadGroupName).then(
        res => {
            console.log(res);
        }
    )
...
async function longTermRetentionBackups_listByResourceGroupDatabase(){
    for await (let item of client.longTermRetentionBackups.listByResourceGroupDatabase(resourceGroup,"eastus",serverName,databaseName)){
        console.log(item);
    }
}
...
async function longTermRetentionBackups_listByResourceGroupServer(){
    for await (let item of client.longTermRetentionBackups.listByResourceGroupServer(resourceGroup,"eastus",serverName)){
        console.log(item);
    }
}
...
async function longTermRetentionBackups_listByResourceGroupLocation(){
    for await (let item of client.longTermRetentionBackups.listByResourceGroupLocation(resourceGroup,"eastus")){
        console.log(item);
    }
}
...
async function longTermRetentionPolicies_beginCreateOrUpdateAndWait(){
    ...
    await client.longTermRetentionPolicies.beginCreateOrUpdateAndWait(resourceGroup,serverName,databaseName,policyName,parameter).then(
        res => {
            console.log(res);
        }
    )
...
async function longTermRetentionPolicies_get(){
    await client.longTermRetentionPolicies.get(resourceGroup,serverName,databaseName,policyName).then(
        res => {
            console.log(res);
        }
    )
...
async function longTermRetentionPolicies_listByDatabase(){
    for await (let item of client.longTermRetentionPolicies.listByDatabase(resourceGroup,serverName,databaseName)){
        console.log(item);
    }
}
...
async function transparentDataEncryptions_createOrUpdate(){
    await client.transparentDataEncryptions.createOrUpdate(resourceGroup,serverName,databaseName,transparentDataEncryptionName,{status: "Enabled"}).then(
        res => {
            console.log(res);
        }
    )
...
async function transparentDataEncryptions_get(){
    await client.transparentDataEncryptions.get(resourceGroup,serverName,databaseName,transparentDataEncryptionName).then(
        res => {
            console.log(res);
        }
    )
...
async function transparentDataEncryptions_listByConfiguration(){
    for await (let item of client.transparentDataEncryptionActivities.listByConfiguration(resourceGroup,serverName,databaseName,transparentDataEncryptionName)){
        console.log(item);
    }
}
...
async function geoBackupPolicies_createOrUpdate(){
    await client.geoBackupPolicies.createOrUpdate(resourceGroup,serverName,databaseName,geobackupPolicyName,{state: "Enabled"}).then(
        res => {
            console.log(res);
        }
    )
...
async function geoBackupPolicies_get(){
    await client.geoBackupPolicies.get(resourceGroup,serverName,databaseName,geobackupPolicyName).then(
        res => {
            console.log(res);
        }
    )
...
async function geoBackupPolicies_listByDatabase(){
    for await (let item of client.geoBackupPolicies.listByDatabase(resourceGroup,serverName,databaseName)){
        console.log(item);
    }
}
...
async function dataMaskingPolicies_createOrUpdate(){
    await client.dataMaskingPolicies.createOrUpdate(resourceGroup,serverName,databaseName,{dataMaskingState: "Disabled"}).then(
        res => {
            console.log(res);
        }
    )
...
async function dataMaskingPolicies_get(){
    await client.dataMaskingPolicies.get(resourceGroup,serverName,databaseName).then(
        res => {
            console.log(res);
        }
    )
...
async function dataMaskingRules_listByDatabase(){
    for await (let item of client.dataMaskingRules.listByDatabase(resourceGroup,serverName,databaseName)){
        console.log(item);
    }
}
...
async function databaseOperations_listByDatabase(){
    for await (let item of client.databaseOperations.listByDatabase(resourceGroup,serverName,databaseName)){
        console.log(item);
        return item.name;
    }
}
...
async function databaseOperations_cancel(){
    ...
    await client.databaseOperations.cancel(resourceGroup,serverName,databaseName,opdatetionId).then(
        res => {
            console.log(res);
        }
    )
...
async function serverConnectionPolicies_createOrUpdate(){
    await client.serverConnectionPolicies.createOrUpdate(resourceGroup,serverName,connectionPolicyName,{connectionType: "Proxy"}).then(
        res => {
            console.log(res);
        }
    )
...
async function databases_listMetrics(){
    for await (let item of client.databases.listMetrics(resourceGroup,serverName,databaseName,"name/value eq 'cpu_percent' and timeGrain eq '00:10:00' and startTime eq '2017-06-02T18:35:00Z' and endTime eq '2017-06-02T18:55:00Z'")){
        console.log(item);
    }
}
...
async function serverConnectionPolicies_get(){
    await client.serverConnectionPolicies.get(resourceGroup,serverName,connectionPolicyName).then(
        res => {
            console.log(res);
        }
    )
...
async function databases_get(){
    await client.databases.get(resourceGroup,serverName,databaseName).then(
        res => {
            console.log(res);
        }
    )
...
async function databaseUsages_listByDatabase(){
    for await (let item of client.databaseUsages.listByDatabase(resourceGroup,serverName,databaseName)){
        console.log(item);
    }
}
...
async function databases_rename(){
    const parameter:ResourceMoveDefinition = {
        id: "/subscriptions/" + subscriptionId + "/resourceGroups/" + resourceGroup + "/providers/Microsoft.Sql/servers/" + serverName + "/databases/" + databaseName+"2"
    };
    await client.databases.rename(resourceGroup,serverName,databaseName,parameter).then(
        res => {
            console.log(res);
        }
    )
...
async function databases_beginUpdateAndWait(){
    ...
    await client.databases.beginUpdateAndWait(resourceGroup,serverName,databaseName2,parameter).then(
        res => {
            console.log(res);
        }
    )
...
async function databases_beginFailoverAndWait(){
    await client.databases.beginFailoverAndWait(resourceGroup,serverName,databaseName2,{replicaType: "Primary"}).then(
        res => {
            console.log(res);
        }
    )
...
async function servers_beginDeleteAndWait(){
    const res = await client.servers.beginDeleteAndWait(resourceGroup,serverName);
    console.log(res);
}
