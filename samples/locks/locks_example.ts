...
const resourceId = "/subscriptions/"+subscriptionId+"/resourceGroups/"+ resourceGroupName +"/providers/Microsoft.Compute/availabilitySets/"+resourceName;
...
async function managementLocks_createOrUpdateAtSubscriptionLevel(){
    const result_create = await lockClient.managementLocks.createOrUpdateAtSubscriptionLevel(lockName,{level: "CanNotDelete"});
    console.log(result_create);
}

//managementLocks.getAtSubscriptionLevel
async function managementLocks_getAtSubscriptionLevel(){
    await lockClient.managementLocks.getAtSubscriptionLevel(lockName).then(
        result => {
            console.log(result);
        }
    )
...
async function managementLocks_listAtSubscriptionLevel(){
    for await (let item of lockClient.managementLocks.listAtSubscriptionLevel()){
        console.log(item);
    }
}
...
async function managementLocks_deleteAtSubscriptionLevel(){
    const delete_result = await lockClient.managementLocks.deleteAtSubscriptionLevel(lockName);
...
async function resources_createOrUpdateById(){
    ...
    await resourceClient.resources.beginCreateOrUpdateByIdAndWait(resourceId,"2019-07-01",parameter).then(
        result => {
            console.log(result);
        }
    )
...
async function managementLocks_createOrUpdateByScope(){
    const lock_create = await lockClient.managementLocks.createOrUpdateByScope(resourceId,lockName,{level: "CanNotDelete"});
    console.log(lock_create);
}

//managementLocks.getByScope
async function managementLocks_getByScope(){
    await lockClient.managementLocks.getByScope(resourceId,lockName).then(
        result => {
            console.log(result);
        }
    )
...
async function managementLocks_listByScope(){
    for await (let item of lockClient.managementLocks.listByScope(resourceId)){
        console.log(item)
    }
}
...
async function managementLocks_deleteByScope(){
    await lockClient.managementLocks.deleteByScope(resourceId,lockName).then(
        result => {
            console.log(result); 
        }
    )
...
async function resources_deleteById(){
    await resourceClient.resources.beginDeleteByIdAndWait(resourceId,"2019-07-01").then(
        result => {
            console.log(result);
        }
    )
...
async function resources_createOrUpdate(){
    const create_result = await resourceClient.resources.beginCreateOrUpdateAndWait(resourceGroupName,"Microsoft.Compute","","availabilitySets",resourceName,"2019-07-01",{location: "eastus"});
    console.log(create_result);
}

//managementLocks.createOrUpdateAtResourceLevel
async function managementLocks_createOrUpdateAtResourceLevel(){
    const lock_create = await lockClient.managementLocks.createOrUpdateAtResourceLevel(resourceGroupName,"Microsoft.Compute","","availabilitySets",resourceName,lockName,{level: "CanNotDelete"});
    console.log(lock_create);
...
async function managementLocks_getAtResourceLevel(){
    await lockClient.managementLocks.getAtResourceLevel(resourceGroupName,"Microsoft.Compute","","availabilitySets",resourceName,lockName).then(
        result => {
            console.log(result);
        }
    )
...
async function managementLocks_listAtResourceLevel(){
    ...
    for await (let item of lockClient.managementLocks.listAtResourceLevel(resourceGroupName,"Microsoft.Compute","","availabilitySets",resourceName)){
        arrayList.push(item);
        // console.log(item);
    }
...
async function managementLocks_deleteAtResourceLevel(){
    await lockClient.managementLocks.deleteAtResourceLevel(resourceGroupName,"Microsoft.Compute","","availabilitySets",resourceName,lockName).then(
        result => {
            console.log(result); 
        }
    )
...
async function resources_delete(){
    await resourceClient.resources.beginDeleteAndWait(resourceGroupName,"Microsoft.Compute","","availabilitySets",resourceName,"2019-07-01").then(
        result => {
            console.log(result);
        }
    )
...
async function managementLocks_createOrUpdateAtResourceGroupLevel(){
    const lock = await lockClient.managementLocks.createOrUpdateAtResourceGroupLevel(resourceGroupName,lockName,{level: "CanNotDelete"});
    console.assert(lock != null);
}

//managementLocks.getAtResourceGroupLevel
async function managementLocks_getAtResourceGroupLevel(){
    await lockClient.managementLocks.getAtResourceGroupLevel(resourceGroupName,lockName).then(
        result => {
            console.log(result);
        }
    )
...
async function managementLocks_listAtResourceGroupLevel(){
    const arrayList = new Array();
    for await (let item of lockClient.managementLocks.listAtResourceGroupLevel(resourceGroupName)){
        arrayList.push(item);
...
async function managementLocks_deleteAtResourceGroupLevel(){
    await lockClient.managementLocks.deleteAtResourceGroupLevel(resourceGroupName,lockName).then(
        result => {
            console.log(result);
        }
    )
...
async function authorizationOperations_list(){
    for await (let item of lockClient.authorizationOperations.list()){
        console.log(item);
    }
}
