...
async function appServicePlans_beginCreateOrUpdateAndWait(){
    ...
    await client.appServicePlans.beginCreateOrUpdateAndWait(resourceGroup,name,parameter).then(
        res => {
            console.log(res);
        }
    )
...
async function appServicePlans_get(){
    await client.appServicePlans.get(resourceGroup,name).then(
        res => {
            console.log(res);
        }
    )
...
async function appServicePlans_update(){
    await client.appServicePlans.update(resourceGroup,name,{kind: "app"}).then(
        res => {
            console.log(res);
        }
    )
...
async function appServicePlans_delete(){
    await client.appServicePlans.delete(resourceGroup,name).then(
        res => {
            console.log(res);
        }
    )
