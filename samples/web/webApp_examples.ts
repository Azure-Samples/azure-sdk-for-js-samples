import { WebSiteManagementClient,AppServicePlan,Site,SiteConfigResource,SiteSourceControl,SitePatchResource } from "azure-arm-appservice";
...
async function appServicePlans_beginCreateOrUpdateAndWait(){
    ...
    await client.appServicePlans.beginCreateOrUpdateAndWait(resourceGroup,appservicePlanName,parameter).then(
        res => {
            console.log(res);
        }
    )
...
async function webApps_beginCreateOrUpdateAndWait(){
    ...
    await client.webApps.beginCreateOrUpdateAndWait(resourceGroup,name,parameter).then(
        res => {
            console.log(res);
        }
    )
...
async function webApps_beginCreateOrUpdateSlotAndWait(){
    ...
    await client.webApps.beginCreateOrUpdateSlotAndWait(resourceGroup,name,soltName,parameter).then(
        res => {
            console.log(res);
        }
    )
...
async function webApps_createOrUpdateConfigurationSlot(){
    ...
    await client.webApps.createOrUpdateConfigurationSlot(resourceGroup,name,soltName,parameter).then(
        res => {
            console.log(res);
        }
    )
...
async function webApps_beginCreateOrUpdateSourceControlSlotAndWait(){
    ...
    await client.webApps.beginCreateOrUpdateSourceControlSlotAndWait(resourceGroup,name,soltName,parameter).then(
        res => {
            console.log(res);
        }
    )
...
async function webApps_getSlot(){
    await client.webApps.getSlot(resourceGroup,name,soltName).then(
        res => {
            console.log(res);
        }
    )
...
async function webApps_getConfigurationSlot(){
    await client.webApps.getConfigurationSlot(resourceGroup,name,soltName).then(
        res => {
            console.log(res);
        }
    )
...
async function webApps_getSourceControlSlot(){
    await client.webApps.getSourceControlSlot(resourceGroup,name,soltName).then(
        res => {
            console.log(res);
        }
    )
...
async function webApps_listSlots(){
    for await (let item of client.webApps.listSlots(resourceGroup,name)){
        console.log(item);
    }
}
...
async function webApps_updateSlot(){
    ...
    await client.webApps.updateSlot(resourceGroup,name,soltName,parameter).then(
        res => {
            console.log(res);
        }
    )
...
async function webApps_updateConfigurationSlot(){
    ...
    await client.webApps.updateConfigurationSlot(resourceGroup,name,soltName,parameter).then(
        res => {
            console.log(res);
        }
    )
...
async function webApps_updateSourceControlSlot(){
    ...
    await client.webApps.updateSourceControlSlot(resourceGroup,name,soltName,parameter).then(
        res => {
            console.log(res);
        }
    )
...
async function webApps_startSlot(){      
    await client.webApps.startSlot(resourceGroup,name,soltName).then(
        res => {
            console.log(res);
        }
    )
...
async function webApps_restartSlot(){      
    await client.webApps.restartSlot(resourceGroup,name,soltName).then(
        res => {
            console.log(res);
        }
    )
...
async function webApps_stopSlot(){      
    await client.webApps.stopSlot(resourceGroup,name,soltName).then(
        res => {
            console.log(res);
        }
    )
...
async function webApps_deleteSourceControlSlot(){      
    await client.webApps.deleteSourceControlSlot(resourceGroup,name,soltName).then(
        res => {
            console.log(res);
        }
    )
...
async function webApps_deleteSlot(){      
    await client.webApps.deleteSlot(resourceGroup,name,soltName).then(
        res => {
            console.log(res);
        }
    )
...
async function webApps_createOrUpdateConfiguration(){
    ...
    await client.webApps.createOrUpdateConfiguration(resourceGroup,name,parameter).then(
        res => {
            console.log(res);
        }
    )
...
async function webApps_beginCreateOrUpdateSourceControlAndWait(){
    ...
    await client.webApps.beginCreateOrUpdateSourceControlAndWait(resourceGroup,name,parameter).then(
        res => {
            console.log(res);
        }
    )
...
async function webApps_getConfiguration(){
    await client.webApps.getConfiguration(resourceGroup,name).then(
        res => {
            console.log(res);
        }
    )
...
async function webApps_get(){
    await client.webApps.get(resourceGroup,name).then(
        res => {
            console.log(res);
        }
    )
...
async function webApps_getSourceControl(){
    await client.webApps.getSourceControl(resourceGroup,name).then(
        res => {
            console.log(res);
        }
    )
...
async function webApps_listConfigurations(){
    for await (let item of client.webApps.listConfigurations(resourceGroup,name)){
        console.log(item);
    }
}
...
async function webApps_update(){
    ...
    await client.webApps.update(resourceGroup,name,parameter).then(
        res => {
            console.log(res);
        }
    )
...
async function webApps_updateConfiguration(){
    ...
    await client.webApps.updateConfiguration(resourceGroup,name,parameter).then(
        res => {
            console.log(res);
        }
    )
...
async function webApps_updateSourceControl(){
    ...
    await client.webApps.updateSourceControl(resourceGroup,name,parameter).then(
        res => {
            console.log(res);
        }
    )
...
async function webApps_start(){      
    await client.webApps.start(resourceGroup,name).then(
        res => {
            console.log(res);
        }
    )
...
async function webApps_restart(){      
    await client.webApps.restart(resourceGroup,name).then(
        res => {
            console.log(res);
        }
    )
...
async function webApps_stop(){      
    await client.webApps.stop(resourceGroup,name).then(
        res => {
            console.log(res);
        }
    )
...
async function webApps_deleteSourceControl(){      
    await client.webApps.deleteSourceControl(resourceGroup,name).then(
        res => {
            console.log(res);
        }
    )
...
async function webApps_updateScmAllowed(){
    await client.webApps.updateScmAllowed(resourceGroup,name,{allow: true}).then(
        res => {
            console.log(res);
        }
    )
...
async function webApps_updateFtpAllowed(){
    await client.webApps.updateFtpAllowed(resourceGroup,name,{allow: true}).then(
        res => {
            console.log(res);
        }
    )
...
async function webApps_getScmAllowed(){
    await client.webApps.getScmAllowed(resourceGroup,name).then(
        res => {
            console.log(res);
        }
    )
...
async function webApps_getFtpAllowed(){
    await client.webApps.getFtpAllowed(resourceGroup,name).then(
        res => {
            console.log(res);
        }
    )
...
async function webApps_getPrivateLinkResources(){
    await client.webApps.getPrivateLinkResources(resourceGroup,name).then(
        res => {
            console.log(res);
        }
    )
...
async function webApps_listSiteBackups(){
    for await (let item of client.webApps.listSiteBackups(resourceGroup,name)){
        console.log(item);
    }
}
...
async function webApps_delete(){      
    await client.webApps.delete(resourceGroup,name).then(
        res => {
            console.log(res);
        }
    )
