...
async function applicationDefinitions_getById() {
  await applicationClient.applicationDefinitions
    .getById(resourceGroupName, appDefinitionName)
    .then((result) => {
      console.log(result);
    });
}
...
async function applications_getById() {
  await applicationClient.applications.getById(applicationId).then((result) => {
    console.log(result);
  });
}
...
async function applications_deleteById() {
  await applicationClient.applications
