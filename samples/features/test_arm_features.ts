...
class TestFeatures {
    ...
    //features.listAll
    public async test_features_listAll(){
    ...
    //features.list
    public async test_features_list(){
        const arrayList = new Array();
    ...
    //features.get
    public async test_features_get(){
        const featureList = await this.test_features_list();
    ...
    //features.register
    public async test_features_register(){
        const feature = await this.test_features_get();
        // console.log(feature)
