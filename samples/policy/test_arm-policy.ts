...
class TestPolicyDefinitionAtManagementGroup {
    ...
    public async test_managementGroups_createOrUpdate(){
        const result = await this.managementclient.managementGroups.createOrUpdate(this.groupId,{name: this.groupId});
        console.log(result);
    }
    ...
    public async test_policyAssignments_createById(){
        const policyId = "20000000-0001-0000-0000-000000000123/providers/Microsoft.Authorization/policyAssignments/"+this.policyAssignmentName;
        const definition = await this.test_policyDefinitions_getAtManagementGroup();
        const assigment = await this.policyclient.policyAssignments.createById(policyId,{policyDefinitionId: definition.id});
        console.log(assigment);
        return assigment;
    }
    ...
    public async test_policySetDefinitions_createOrUpdateAtManagementGroup(){
        await this.policyclient.policySetDefinitions.createOrUpdateAtManagementGroup(this.policySetName,this.groupId,{}).then(
            result => {
                console.log(result);
            }
        )
    ...
    public async test_managementGroups_delete(){
        await this.managementclient.managementGroups.delete(this.groupId).then(
            result => {
                console.log(result)
            }
        )
...
const tm = new TestPolicyDefinitionAtManagementGroup()
