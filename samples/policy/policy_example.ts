...
const policyId = "/subscriptions/" + subscriptionId + "/resourceGroups/" + resourceGroupName + "/providers/Microsoft.Authorization/policyAssignments/" +policyAssignmentName;
...
async function managementGroups_createOrUpdate(){
    const result = await managementclient.managementGroups.beginCreateOrUpdateAndWait(groupId,{name: groupId});
    console.log(result);
}
...
async function policyDefinitions_createOrUpdateAtManagementGroup(){
    ...
    const definition = await policyclient.policyDefinitions.createOrUpdateAtManagementGroup(policyName,groupId,parameter);
    console.log(definition);
}

//policyDefinitions.getAtManagementGroup
async function policyDefinitions_getAtManagementGroup(){
    const definition = await policyclient.policyDefinitions.getAtManagementGroup(policyName,groupId);
    console.log(definition);
    return definition;
}
...
async function policyDefinitions_listByManagementGroup(){
    for await (let item of policyclient.policyDefinitions.listByManagementGroup(groupId)){
        console.log(item);
    }
}
...
async function policyDefinitions_listBuiltIn(){
    ...
    for await (let item of policyclient.policyDefinitions.listBuiltIn()){
        arrayList.push(item);
        console.log(item);
    }
    return arrayList;
...
async function policyDefinitions_getBuiltIn(){
    ...
    await policyclient.policyDefinitions.getBuiltIn(arrayOne[0].name).then(
        result => {
            console.log(result);
        }
    )
...
async function policyAssignments_listForManagementGroup(){
    for await (let item of policyclient.policyAssignments.listForManagementGroup(groupId,{filter:"atScope()"})){
        console.log(item);
    }
}
...
async function policyAssignments_create(){
    ...
    const assigment = await policyclient.policyAssignments.create(scope,policyAssignmentName,{policyDefinitionId: definition.id});
...
async function policyAssignments_get(){
    ...
    await policyclient.policyAssignments.get(assigment.scope,assigment.name).then(
        result => {
            console.log(result);
        }
    )
...
async function policyAssignments_list(){
    const arrayList = new Array();
    for await (let item of policyclient.policyAssignments.list()){
        arrayList.push(item);
        console.log(item)
    }
...
async function policyAssignments_listForResourceGroup(){
    const arrayList = new Array();
    for await (let item of policyclient.policyAssignments.listForResourceGroup(resourceGroupName)){
        arrayList.push(item);
        console.log(item)
    }
...
async function policyAssignments_listForResource(){
    const arrayList = new Array();
    for await (let item of policyclient.policyAssignments.listForResource(resourceGroupName,"Microsoft.Compute","","availabilitySets","jstrack2test")){
        arrayList.push(item);
        console.log(item)
    }
...
async function policyAssignments_delete(){
    const scope = "/providers/Microsoft.Management/managementgroups/20000000-0001-0000-0000-000000000123/";
    await policyclient.policyAssignments.delete(scope,policyAssignmentName).then(
        result => {
            console.log(result);
        }
    )
...
async function policySetDefinitions_createOrUpdateAtManagementGroup(){
    const parameter:PolicySetDefinition = {  
        policyDefinitions: [
            {
                policyDefinitionId: "/providers/Microsoft.Management/managementgroups/"+groupId+"/providers/Microsoft.Authorization/policyDefinitions/" + policyName,
                policyDefinitionReferenceId: "Limit_Skus",   
            }
        ]  
    }
    await policyclient.policySetDefinitions.createOrUpdateAtManagementGroup(policySetName,groupId,parameter).then(
        result => {
            console.log(result);
        }
    )
...
async function policySetDefinitions_getAtManagementGroup(){
    await policyclient.policySetDefinitions.getAtManagementGroup(policySetName,groupId).then(
        result => {
            console.log(result);
        }
    )
...
async function policySetDefinitions_listByManagementGroup(){
    const arrayList = new Array();
    for await (let item of policyclient.policySetDefinitions.listByManagementGroup(groupId)){
        arrayList.push(item);
        console.log(item);
    }
}
...
async function policySetDefinitions_listBuiltIn(){
    const arrayList = new Array();
    for await (let item of policyclient.policySetDefinitions.listBuiltIn()){
        arrayList.push(item);
        console.log(item);
    }
    // console.assert()
...
async function policySetDefinitions_list(){
    const arrayList = new Array();
    for await (let item of policyclient.policySetDefinitions.list()){
        arrayList.push(item);
        console.log(item);
    }
}
...
async function policySetDefinitions_getBuiltIn(){
    ...
    await policyclient.policySetDefinitions.getBuiltIn(arrayList[0].name).then(
        result => {
            console.log(result);
        }
    )
...
async function policySetDefinitions_deleteAtManagementGroup(){
    await policyclient.policySetDefinitions.deleteAtManagementGroup(policySetName,groupId).then(
        result => {
            console.log(result);
        }
    )
...
async function policyDefinitions_deleteAtManagementGroup(){
    await policyclient.policyDefinitions.deleteAtManagementGroup(policyName,groupId).then(
        result => {
            console.log(result);
        }
    )
...
async function managementGroups_delete(){
    await managementclient.managementGroups.beginDeleteAndWait(groupId).then(
        result => {
            console.log(result)
        }
    )
...
async function policyDefinitions_createOrUpdate(){
    ...
    const definition = await policyclient.policyDefinitions.createOrUpdate(policyName,parameter);
    console.log(definition);
    return definition;
}
...
async function policyDefinitions_get(){
    ...
    await policyclient.policyDefinitions.get(definition.name).then(
        result => {
            console.log(result);
        }
    )
...
async function policyDefinitions_list(){
    const arrayList = new Array();
    for await (let item of policyclient.policyDefinitions.list()){
        arrayList.push(item);
        console.log(item);
    }
    console.assert(arrayList.length > 0)
...
async function policySetDefinitions_createOrUpdate(){
    ...
    await policyclient.policySetDefinitions.createOrUpdate(policySetName,parameter).then(
        result => {
            console.log(result);
        }
    )
...
async function policyAssignments_createById(){
    const definition = await policyDefinitions_createOrUpdate();
    const assigment = await policyclient.policyAssignments.createById(policyId,{policyDefinitionId:definition.id});
    console.log(assigment);
    return assigment;
}
...
async function policySetDefinitions_get(){
    await policyclient.policySetDefinitions.get(policySetName).then(
        result => {
            console.log(result);
        }
    )
...
async function policyAssignments_getById(){
    ...
    await policyclient.policyAssignments.getById(assigment.id).then(
        result => {
            console.log(result);
        }
    )
...
async function policyAssignments_deleteById(){
    const assigment = await policyAssignments_createById();
    await policyclient.policyAssignments.deleteById(assigment.id).then(
        result => {
            console.log(result);
        }
    )
...
async function policySetDefinitions_delete(){
    await policyclient.policySetDefinitions.delete(policySetName).then(
        result => {
            console.log(result);
        }
    )
...
async function policyDefinitions_delete(){
    const definition = await policyDefinitions_createOrUpdate();
    await policyclient.policyDefinitions.delete(definition.name).then(
        result => {
            console.log(result);
        }
    )
